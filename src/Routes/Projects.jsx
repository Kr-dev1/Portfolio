...
const Projects = () => {
  return (
    <div className="flex justify-center items-center text-white font-kanit mx-20 mb-20 md:my-0">
      <div className=" grid grid-flow-row gap-8 md:gap-4 md:grid-cols-2">
        ...
        <div className="bg-[#202020] drop-shadow-projects rounded-xl px-4 py-12 mt-auto">
          <div>
            <p>
              <a
                className="border-b-[2px]"
          ...
          <div className="flex items-center justify-center gap-10 pt-16 drop-shadow-projects">
